...
public class NgsiRestControllerTest {
    ...
    public void testAppendContextElement_OK() throws Exception {
        ArgumentCaptor<UpdateContextCepheus> updateContextArg = ArgumentCaptor.forClass(UpdateContextCepheus.class);
        ...
        when(ngsiController.updateContextCepheus(any())).thenReturn(response);
        ...
        verify(ngsiController).updateContextCepheus(updateContextArg.capture());

        UpdateContextCepheus updateContextRequest = updateContextArg.getValue();
        assertNotNull(updateContextRequest);
        assertEquals(UpdateAction.APPEND, updateContextRequest.getUpdateContext().getUpdateAction());
        assertEquals("12345678", updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getId());
        assertEquals("", updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getType());
        assertEquals(false, updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getIsPattern());
    }
    ...
    public void testAppendContextElement_Error() throws Exception {
        ...
        verify(ngsiController).updateContextCepheus(any());
    }
    ...
    public void testUpdateContextElement_OK() throws Exception {
        ...
        UpdateContextCepheus updateContextRequest = updateContextArg.getValue();
        assertNotNull(updateContextRequest);
        assertEquals(UpdateAction.UPDATE, updateContextRequest.getUpdateContext().getUpdateAction());
        assertEquals("12345678", updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getId());
        assertEquals("", updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getType());
        assertEquals(false, updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getIsPattern());
    }
    ...
    public void testDeleteContextElement_OK() throws Exception {
        ...
        UpdateContextCepheus updateContext = updateContextArg.getValue();
        assertNotNull(updateContext);
        assertNotNull(updateContext.getUpdateContext().getContextElements());
        assertEquals(1, updateContext.getUpdateContext().getContextElements().size());
        assertEquals(UpdateAction.DELETE, updateContext.getUpdateContext().getUpdateAction());
        assertEquals("12345678", updateContext.getUpdateContext().getContextElements().get(0).getEntityId().getId());
        assertEquals("", updateContext.getUpdateContext().getContextElements().get(0).getEntityId().getType());
        assertEquals(false, updateContext.getUpdateContext().getContextElements().get(0).getEntityId().getIsPattern());
    }
    ...
    public void testAppendContextAttribute_OK() throws Exception {
        ...
        assertNotNull(updateContextRequest);
        assertEquals(UpdateAction.APPEND, updateContextRequest.getUpdateContext().getUpdateAction());
        assertNotNull(updateContextRequest.getUpdateContext().getContextElements());
        assertEquals(1, updateContextRequest.getUpdateContext().getContextElements().size());
        assertNotNull(updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId());
        assertEquals("12345678", updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getId());
        assertEquals("", updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getType());
        assertEquals(false, updateContextRequest.getUpdateContext().getContextElements().get(0).getEntityId().getIsPattern());
        assertNotNull(updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList());
        assertEquals(1, updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().size());
        assertEquals("temp", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getName());
        assertEquals("float", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getType());
        assertEquals("15.5", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getValue());
    }
    ...
    public void testDeleteContextAttribute_OK() throws Exception {
        ...
        assertEquals("", updateContext.getUpdateContext().getContextElements().get(0).getEntityId().getType());
        assertEquals(false, updateContext.getUpdateContext().getContextElements().get(0).getEntityId().getIsPattern());
        assertNotNull(updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList());
        assertEquals(1, updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().size());
        assertEquals("test", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getName());
        assertEquals("", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getType());
        assertEquals("", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getValue());
    }
    ...
    public void testUpdateContextAttributeValue_OK() throws Exception {
        ...
        assertEquals("float", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getType());
        assertEquals("15.5", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getValue());
        assertNotNull(updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata());
        assertEquals(1, updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().size());
        assertEquals("ID", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().get(0).getName());
        assertEquals("string", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().get(0).getType());
        assertEquals("DEADBEEF", updateContextRequest.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().get(0).getValue());
    }
    ...
    public void testDeleteContextAttributeValue_OK() throws Exception {
        ...
        assertEquals("", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getType());
        assertEquals("", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getValue());
        assertNotNull(updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata());
        assertEquals(1, updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().size());
        assertEquals("ID", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().get(0).getName());
        assertEquals("string", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().get(0).getType());
        assertEquals("DEADBEEF", updateContext.getUpdateContext().getContextElements().get(0).getContextAttributeList().get(0).getMetadata().get(0).getValue());
    }
