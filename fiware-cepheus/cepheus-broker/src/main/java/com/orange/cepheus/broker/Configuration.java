...
public class Configuration {
	...
	public String toString() {
		return "Configuration [localUrl=" + localUrl + ", remoteUrl=" + remoteUrl + ", remoteServiceName="
				+ remoteServiceName + ", remoteServicePath=" + remoteServicePath + ", remoteAuthToken="
				+ remoteAuthToken + ", remoteForwardUpdateContext=" + remoteForwardUpdateContext + "]";
	}
