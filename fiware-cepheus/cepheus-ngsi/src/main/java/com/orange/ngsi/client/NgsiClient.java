...
public class NgsiClient {
    ...
    public ListenableFuture<UpdateContextResponse> updateContextCepheus(String url, HttpHeaders httpHeaders, UpdateContextCepheus updateContextCepheus) {
    	return request(url + "/ngsi10/updateContextCepheus", httpHeaders, updateContextCepheus, UpdateContextResponse.class);
	}
