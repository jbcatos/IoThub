...
public class NgsiBaseController {
    ...
    @RequestMapping(value = "/updateContextCepheus", method = RequestMethod.POST, consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE})
    final public ResponseEntity<UpdateContextResponse> updateContextRequest(@RequestBody final UpdateContextCepheus updateContextCepheus, HttpServletRequest httpServletRequest) throws Exception {
        ngsiValidation.checkUpdateContextCepheus(updateContextCepheus);
        registerIntoDispatcher(httpServletRequest);
        return new ResponseEntity<>(updateContextCepheus(updateContextCepheus), HttpStatus.OK);
    }
    ...
    public UpdateContextResponse updateContextCepheus(UpdateContextCepheus updateContextCepheus) throws Exception {
    	throw new UnsupportedOperationException("updateContextCepheus");
	}
